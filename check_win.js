...
function announce_winner (winning_mark) {
	...
	if (winning_mark === player_1.data_name) {
		...
		setTimeout(function () {
			...
			$buttons_row.append("<h1 style='font-size: 4em; margin: 13vh 0 25px 0'>"+ winning_mark + " has won!</h1>").fadeIn();
			play_again ();
		...
		setTimeout(function () {
 			...
 			$buttons_row.append("<h1 style='font-size: 4em; margin: 13vh 0 25px 0'>"+ winning_mark + " has won!</h1>");
 			play_again ();
		...
		setTimeout(function () {
	 		...
	 		$buttons_row.append("<h1 style='font-size: 4em; margin: 13vh 0 25px 0'>Computer wins!</h1>").fadeIn();
	 		play_again ();
